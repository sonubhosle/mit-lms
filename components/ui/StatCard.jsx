...
export default function StatCard({ title, value, icon: Icon, trend, trendValue, color }) {
  return (
    <div className="group bg-white p-6 rounded-[2rem] shadow-sm shadow-slate-100 border border-slate-100 hover:border-indigo-200 hover:shadow-md hover:shadow-indigo-100/50 hover:-translate-y-1 transition-all duration-300 flex items-center gap-6">
